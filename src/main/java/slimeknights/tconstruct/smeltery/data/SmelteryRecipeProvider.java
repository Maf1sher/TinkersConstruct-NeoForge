...
public class SmelteryRecipeProvider extends BaseRecipeProvider implements ISmelteryRecipeHelper, ICommonRecipeHelper {
  /** Helper to create a potion item stack, replacing the removed PotionUtils.setPotion */
  private static ItemStack makePotionStack(ItemLike item, Holder<Potion> potion) {
  ...
  private void addSmelteryRecipes(RecipeOutput consumer) {
    ...
    // blast furnace recipe, also serves as kiln fallback
    SimpleCookingRecipeBuilder.blasting(Ingredient.of(TinkerSmeltery.grout), RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.searedBrick, 0.3f, 100)
                        .unlockedBy("has_item", has(TinkerSmeltery.grout))
                        .save(consumer, wrap(TinkerSmeltery.searedBrick, folder, "_kiln"));
    ...
    // cobble
    searedCasting(consumer, TinkerSmeltery.searedCobble, CompoundIngredient.of(Ingredient.of(Tags.Items.COBBLESTONES_NORMAL), Ingredient.of(Blocks.GRAVEL)), castingFolder + "cobble/block");
  ...
  private void addFoundryRecipes(RecipeOutput consumer) {
    ...
    SimpleCookingRecipeBuilder.blasting(Ingredient.of(TinkerSmeltery.netherGrout), RecipeCategory.BUILDING_BLOCKS, TinkerSmeltery.scorchedBrick, 0.3f, 100)
                              .unlockedBy("has_item", has(TinkerSmeltery.netherGrout))
                              .save(consumer, wrap(TinkerSmeltery.scorchedBrick, folder, "_kiln"));
  ...
  private void addCastingRecipes(RecipeOutput consumer) {
    ...
    ItemCastingRecipeBuilder.tableRecipe(ItemOutput.fromStack(makePotionStack(Items.POTION, Potions.WATER)))
                            .setFluid(MantleTags.Fluids.WATER, FluidValues.BOTTLE * 2)
                            .setCoolingTime(1)
                            .setCast(Items.GLASS_BOTTLE, true)
                            .save(consumer, location(waterFolder + "bottle"));
    ItemCastingRecipeBuilder.tableRecipe(ItemOutput.fromStack(makePotionStack(Items.SPLASH_POTION, Potions.WATER)))
                            .setFluid(MantleTags.Fluids.WATER, FluidValues.BOTTLE * 2)
                            .setCoolingTime(1)
                            .setCast(TinkerTags.Items.SPLASH_BOTTLE, true)
                            .save(consumer, location(waterFolder + "splash"));
    ItemCastingRecipeBuilder.tableRecipe(ItemOutput.fromStack(makePotionStack(Items.LINGERING_POTION, Potions.WATER)))
                            .setFluid(MantleTags.Fluids.WATER, FluidValues.BOTTLE * 2)
                            .setCoolingTime(1)
    ...
    ItemCastingRecipeBuilder.basinRecipe(Blocks.ANDESITE)
                            ...
                            .setCast(Tags.Items.COBBLESTONES_NORMAL, true)
  ...
  private void addMeltingRecipes(RecipeOutput consumer) {
    ...
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(ResourceLocation.fromNamespaceAndPath("tools_complement", "netherite_excavator")).toIngredient(), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
    ...
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(ResourceLocation.fromNamespaceAndPath("tools_complement", "netherite_hammer")).toIngredient(), TinkerFluids.moltenNetherite, FluidValues.INGOT)
                        .setDamagable(netheriteSizes)
  ...
  private void addAlloyRecipes(RecipeOutput consumer) {
    ...
    // cheaper variant: 4 debris + 2 gold
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenNetherite, FluidValues.NUGGET)
                       ...
                       .save(withCondition(consumer, ConfigEnabledCondition.CHEAPER_NETHERITE_ALLOY), prefix(TinkerFluids.moltenNetherite, folder));
    // vanilla cost variant: 4 debris + 4 gold (fallback when cheaper config is off)
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenNetherite, FluidValues.NUGGET)
                       .addInput(TinkerFluids.moltenDebris.ingredient(FluidValues.NUGGET * 4))
                       .addInput(TinkerFluids.moltenGold.ingredient(FluidValues.NUGGET * 4))
                       .save(withCondition(consumer, new NotCondition(ConfigEnabledCondition.CHEAPER_NETHERITE_ALLOY)), prefix(TinkerFluids.moltenNetherite, folder + "vanilla_cost/"));
    ...
    RecipeOutput pewterBase = withCondition(consumer, new OrCondition(List.of(ConfigEnabledCondition.ALLOW_INGOTLESS_ALLOYS, tagCondition("ingots/pewter"))));
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenPewter, FluidValues.INGOT * 4)
      ...
      .save(withCondition(pewterBase, new AndCondition(List.of(lead, tin))), prefix(TinkerFluids.moltenPewter, folder));
    // metalborn does pewter without lead - substitute iron
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenPewter, FluidValues.INGOT * 4)
      .addInput(TinkerFluids.moltenTin.ingredient(FluidValues.INGOT * 3))
      .addInput(TinkerFluids.moltenIron.ingredient(FluidValues.INGOT))
      .save(withCondition(pewterBase, tin, new NotCondition(lead)), prefix(TinkerFluids.moltenPewter, folder + "no_lead/"));
    // Edilon does pewter without tin - substitute iron
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenPewter, FluidValues.INGOT * 2)
      .addInput(TinkerFluids.moltenIron.ingredient(FluidValues.INGOT))
      .addInput(TinkerFluids.moltenLead.ingredient(FluidValues.INGOT))
      .save(withCondition(pewterBase, lead, new NotCondition(tin)), prefix(TinkerFluids.moltenPewter, folder + "no_tin/"));
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenNicrosil, FluidValues.INGOT * 4)
      ...
      .addInput(TinkerFluids.moltenQuartz.ingredient(FluidValues.GEM))
      .save(withCondition(consumer, chromium, nickel), prefix(TinkerFluids.moltenNicrosil, folder));
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenNicrosil, FluidValues.INGOT * 4)
      ...
      .addInput(TinkerFluids.moltenQuartz.ingredient(FluidValues.GEM))
      .save(withCondition(consumer, nickel, new NotCondition(chromium)), prefix(TinkerFluids.moltenNicrosil, folder + "no_chromium/"));
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenNicrosil, FluidValues.INGOT * 4)
      ...
      .addInput(TinkerFluids.moltenIron.ingredient(FluidValues.INGOT))
      .addInput(TinkerFluids.moltenQuartz.ingredient(FluidValues.GEM))
      .save(withCondition(consumer, chromium, new NotCondition(nickel)), prefix(TinkerFluids.moltenNicrosil, folder + "no_nickel/"));
    ...
    AlloyRecipeBuilder.alloy(TinkerFluids.moltenNicrosil, FluidValues.INGOT * 4)
      ...
      .addInput(TinkerFluids.moltenEmerald.ingredient(FluidValues.GEM))
      .addInput(TinkerFluids.moltenQuartz.ingredient(FluidValues.GEM))
      .save(withCondition(consumer, tagCondition("ingots/tin"), new NotCondition(chromium), new NotCondition(nickel)), prefix(TinkerFluids.moltenNicrosil, folder + "fallback/"));
  ...
  private void addCompatRecipes(RecipeOutput consumer) {
    ...
    Function<String,Ingredient> ceramicsItem = name -> ItemNameIngredient.from(ResourceLocation.fromNamespaceAndPath(ceramics, name)).toIngredient();
    ...
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(ceramicsId.apply("clay_faucet"), ceramicsId.apply("clay_channel")).toIngredient(), TinkerFluids.moltenClay, FluidValues.BRICK * 2, 0.65f)
      .save(ceramicsConsumer, location(clayFolder + "clay_2"));
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(ceramicsId.apply("unfired_clay_bucket"), ceramicsId.apply("clay_cistern")).toIngredient(), TinkerFluids.moltenClay, FluidValues.BRICK * 3, 0.9f)
    ...
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(
      ...
      ).toIngredient(), TinkerFluids.moltenClay, FluidValues.BRICK * 2, 1.33f)
    ...
    ).toIngredient(), TinkerFluids.moltenClay, FluidValues.BRICK * 4, 2.0f)
    ...
    ).toIngredient(), TinkerFluids.moltenClay, FluidValues.BRICK_BLOCK, 2f)
    ...
    MeltingRecipeBuilder.melting(ItemNameIngredient.from(ceramicsId.apply("unfired_faucet"), ceramicsId.apply("unfired_channel")).toIngredient(), TinkerFluids.moltenPorcelain, FluidValues.BRICK * 2, 0.65f)
    ...
    ).toIngredient(), TinkerFluids.moltenPorcelain, FluidValues.BRICK * 2, 1.33f)
    ...
    MeltingRecipeBuilder.melting(CompoundIngredient.of(
      ...
      ).toIngredient()), TinkerFluids.moltenPorcelain, FluidValues.BRICK * 4, 2.0f)
    ...
    ).toIngredient(), TinkerFluids.moltenPorcelain, FluidValues.BRICK * 4, 2f)
