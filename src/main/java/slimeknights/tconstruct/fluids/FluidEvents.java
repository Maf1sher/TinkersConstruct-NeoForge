...
public class FluidEvents {
  ...
  /** Registers fluid capabilities for special items via RegisterCapabilitiesEvent (called from mod bus) */
  public static void registerCapabilities(RegisterCapabilitiesEvent event) {
    // powder snow bucket fluid capability
    event.registerItem(Capabilities.FluidHandler.ITEM, (stack, ctx) ->
        new ConstantFluidContainerWrapper(
            new FluidStack(TinkerFluids.powderedSnow.get(), FluidType.BUCKET_VOLUME),
            stack,
