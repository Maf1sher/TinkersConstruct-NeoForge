...
public class Config {
  ...
  public static class Common {
    ...
    Common(ModConfigSpec.Builder builder) {
      ...
      // In 1.21, enchantments are fully data-driven, equipment slot applicability is defined in the enchantment's JSON data.
      // The fire/blast protection slot extension tweaks are no longer needed as this is now controlled via data packs.
