...
public class MoldingRecipeBuilder extends AbstractRecipeBuilder<MoldingRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    @Nullable AdvancementHolder advancement = buildOptionalAdvancement(consumer, id, "molding");
    MoldingRecipe recipe = new MoldingRecipe(serializer, id, material, pattern, patternConsumed, output);
