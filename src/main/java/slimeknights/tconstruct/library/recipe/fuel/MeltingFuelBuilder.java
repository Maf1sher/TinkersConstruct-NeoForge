...
public class MeltingFuelBuilder extends AbstractRecipeBuilder<MeltingFuelBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    @Nullable AdvancementHolder advancement = this.buildOptionalAdvancement(consumer, id, "melting_fuel");
    saveRecipe(consumer, id, new MeltingFuel(id, input, duration, temperature, rate), advancement);
  }
}
