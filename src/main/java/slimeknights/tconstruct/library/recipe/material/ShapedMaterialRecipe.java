...
public class ShapedMaterialRecipe extends ShapedRecipe {
  ...
  public MaterialValueIngredient getMaterial() {
    if (material == null) {
      ...
      for (Ingredient ingredient : getIngredients()) {
        // collect all ingredients that match - in 1.21, Ingredient wraps ICustomIngredient
  ...
  public static class Serializer implements RecipeSerializer<ShapedMaterialRecipe> {
    ...
    private static final StreamCodec<RegistryFriendlyByteBuf, List<MaterialVariantId>> EXTRA_MATERIALS_STREAM_CODEC =
      StreamCodec.of(
        ...
        buf -> {
          ...
          java.util.ArrayList<MaterialVariantId> list = new java.util.ArrayList<>(size);
    ...
    public static final MapCodec<ShapedMaterialRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, ShapedMaterialRecipe> STREAM_CODEC = StreamCodec.composite(
      ShapedRecipe.Serializer.STREAM_CODEC, r -> (ShapedRecipe) r,
      EXTRA_MATERIALS_STREAM_CODEC, r -> r.extraMaterials,
