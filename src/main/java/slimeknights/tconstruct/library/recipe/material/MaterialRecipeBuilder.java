...
public class MaterialRecipeBuilder extends AbstractRecipeBuilder<MaterialRecipeBuilder> {
  ...
  public void save(RecipeOutput consumerIn, ResourceLocation id) {
    ...
    @Nullable AdvancementHolder advancement = this.buildOptionalAdvancement(consumerIn, id, "materials");
    saveRecipe(consumerIn, id, new MaterialRecipe(id, group, ingredient, value, needed, material, leftover), advancement);
  }
}
