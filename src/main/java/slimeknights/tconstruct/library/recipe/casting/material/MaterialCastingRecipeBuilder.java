...
public class MaterialCastingRecipeBuilder extends AbstractRecipeBuilder<MaterialCastingRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    if (result != null) {
      saveRecipe(consumer, id, new MaterialCastingRecipe(recipeSerializer, id, group, cast, itemCost, result, allowedMaterials, castPurpose != CastPurpose.CATALYST, switchSlots), advancement);
    } else if (resultTool != null) {
      saveRecipe(consumer, id, new ToolCastingRecipe(recipeSerializer, id, group, cast, itemCost, castPurpose, resultTool, allowedMaterials, extraMaterials), advancement);
    } else {
