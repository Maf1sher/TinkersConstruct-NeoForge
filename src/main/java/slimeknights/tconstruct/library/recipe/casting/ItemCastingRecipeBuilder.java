...
public class ItemCastingRecipeBuilder extends AbstractRecipeBuilder<ItemCastingRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    if (result == ItemOutput.EMPTY) {
      ...
      saveRecipe(consumer, id, new CastDuplicationRecipe(recipeSerializer, id, group, cast, fluid, coolingTime), advancement);
    } else {
      ...
      saveRecipe(consumer, id, new ItemCastingRecipe(recipeSerializer, id, group, cast, fluid, result, coolingTime, consumed && cast != Ingredient.EMPTY, switchSlots), advancement);
    }
  }
}
