...
public class ModifierRemovalRecipeBuilder extends AbstractSizedIngredientRecipeBuilder<ModifierRemovalRecipeBuilder> {
  ...
  public void save(RecipeOutput consumer, ResourceLocation id) {
    ...
    AdvancementHolder advancement = buildOptionalAdvancement(consumer, id, "modifiers");
    saveRecipe(consumer, id, constructor.apply(id, name, tools, inputs, leftovers, modifierPredicate), advancement);
  }
}
